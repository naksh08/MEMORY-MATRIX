...
// stores info about first card, whether its flipped or not
...
function flipCard() {
  // prevents the execution of function if the board is locked or if the same card is clicked twice
  if (lockBoard || this === firstCard) {
    return;
  }
  this.classList.add("flipped");
  // adds the 'flipped' CSS class to the clicked card
  console.log(this);
